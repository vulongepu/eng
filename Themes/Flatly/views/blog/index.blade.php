...
@section('content')
    <div class="container">
        ...
        <div class="row">
            <div class="col-dl-9">
                ...
                <div class="col-left color1">
                    ...
                    <div class="row-forum">
                        ...
                        <div class="subcate">
                            <ul class="news_related">
                                <li><a href="http://hocvientienganh.com/chuyen-muc/toeic-listening.html">TOEIC Listening </a></li>
                                <li><a href="http://hocvientienganh.com/chuyen-muc/toeic-speaking.html">TOEIC Speaking </a></li>
                                <li><a href="http://hocvientienganh.com/chuyen-muc/toeic-reading.html">TOEIC Reading </a></li>
                                <li><a href="http://hocvientienganh.com/chuyen-muc/toeic-writing.html">TOEIC Writing </a></li>
                                <li><a href="http://hocvientienganh.com/chuyen-muc/toeic-vocabulary-grammar.html">TOEIC Vocabulary/ Grammar</a></li>
                    ...
                    <div class="row-forum">
                        ...
                        <div class="subcate">
                            <ul class="news_related">
                                <li><a href="http://hocvientienganh.com/chuyen-muc/luyen-thi-gre.html">Luyện thi GRE</a></li>
                                <li><a href="http://hocvientienganh.com/chuyen-muc/luyen-thi-gmat.html">Luyện thi GMAT</a></li>
                                <li><a href="http://hocvientienganh.com/chuyen-muc/luyen-thi-sat.html">Luyện thi SAT</a></li>
                            </ul>
                            <div class="clearfix"></div>
                        </div>
                        <ul class="news_related">
                ...
                <div class="col-left color2">
                    ...
                    <div class="row-forum">
                        ...
                        <h3 class="row-forum-name"><a href="http://hocvientienganh.com/chuyen-muc/youtube.html">YOUTUBE</a></h3>
                    ...
                    <div class="row-forum">
                        ...
                        <h3 class="row-forum-name"><a href="http://hocvientienganh.com/chuyen-muc/voa.html">VOA</a></h3>
                    ...
                    <div class="row-forum">
                        ...
                        <h3 class="row-forum-name"><a href="http://hocvientienganh.com/chuyen-muc/cnn.html">CNN</a></h3>
                    ...
                    <div class="row-forum">
                        ...
                        <ul class="news_related">
                            <li><a href="http://hocvientienganh.com/bai-viet/Hoc-tieng-Anh-voi-bai-hat-Let-it-go_3689.html">Học tiếng Anh với bài hát Let it go</a></li>
                        </ul>
                        <div class="clearfix"></div>
                    </div>
                </div>
                <div class="col-left color4">
                    ...
                    <div class="row-forum">
                        ...
                        <h3 class="row-forum-name"><a href="http://hocvientienganh.com/chuyen-muc/tu-vung-theo-chu-de.html">Từ Vựng Theo Chủ Đề</a></h3>
                    ...
                    <div class="row-forum">
                        ...
                        <h3 class="row-forum-name"><a href="http://hocvientienganh.com/chuyen-muc/thanh-ngu.html">Thành Ngữ </a></h3>
                    ...
                    <div class="row-forum">
                        ...
                        <h3 class="row-forum-name"><a href="http://hocvientienganh.com/chuyen-muc/phrasal-verb.html">Phrasal Verb</a></h3>
                    ...
                    <div class="row-forum">
                        ...
                        <h3 class="row-forum-name"><a href="http://hocvientienganh.com/chuyen-muc/ngu-phap-co-ban-amp-nang-cao.html">Ngữ Pháp Cơ Bản &amp; Nâng Cao</a></h3>
                ...
                <div class="col-left color3">
                    ...
                    <div class="row-forum">
                        ...
                        <h3 class="row-forum-name"><a href="http://hocvientienganh.com/chuyen-muc/pronunciation.html">Pronunciation</a></h3>
                    ...
                    <div class="row-forum">
                        ...
                        <h3 class="row-forum-name"><a href="http://hocvientienganh.com/chuyen-muc/listening.html">Listening </a></h3>
                ...
                <div class="col-left color7">
                    ...
                    <div class="row-forum">
                        ...
                        <h3 class="row-forum-name"><a href="http://hocvientienganh.com/chuyen-muc/phuong-phap-hoc-tieng-anh-hieu-qua.html">Phương pháp học Tiếng Anh hiệu quả</a></h3>
                    ...
                    <div class="row-forum">
                        ...
                        <h3 class="row-forum-name"><a href="http://hocvientienganh.com/chuyen-muc/loi-thuong-gap.html">Lỗi thường gặp</a></h3>
                    ...
                    <div class="row-forum">
                        ...
                        <h3 class="row-forum-name"><a href="http://hocvientienganh.com/chuyen-muc/kinh-nghiem-du-hoc-amp-san-hoc-bong.html">Kinh nghiệm Du học &amp; săn Học bổng </a></h3>
                ...
                <div class="col-left color8">
                    ...
                    <div class="row-forum">
                        ...
                        <h3 class="row-forum-name"><a href="http://hocvientienganh.com/chuyen-muc/doc-bao.html">Đọc Báo </a></h3>
                    ...
                    <div class="row-forum">
                        ...
                        <h3 class="row-forum-name"><a href="http://hocvientienganh.com/chuyen-muc/truyen-amp-tho.html">Truyện &amp; Thơ</a></h3>
            ...
            <div class="col-dl-3" id="hocvientienganh">
                ...
                <div class="rightsub">
                    <h4 class="title-right">Bài viết mới nhất</h4>
                    <ul class="rightsub-list">
                        @foreach($posts as $post)
                            <li>
                                <a href="http://hocvientienganh.com/forum/{{ $post->slug }}">{{ $post->title }}</a>
                                <?php
                                ...
                                $name = $ran[$name_k];
                                ?>
                                <span class="author-list" style="cursor:pointer;color:#ff9e47;">{{ $name }}</span> - <span>31/07/2015</span>
                            </li>
                        @endforeach
                    </ul>
                </div>
                ...
                <div class="rightsub">
                    <h4 class="title-right">Thống kê website</h4>
                    <ul class="statics">
                        <li id="hocvientienganh">Bài viết:<span>35234</span></li>
                        <li>Thành viên:<span>969</span></li>
                        <li id="hocvientienganh">Trả lời:<span>762</span></li>
                    </ul>
                </div>
            </div>
            <div class="clearfix"></div>
